import{_ as e,r as i,o as t,c as l,d as n,b as s,a as o,e as p}from"./app-QUibh-g2.js";const c={},r=n("h1",{id:"node",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#node","aria-hidden":"true"},"#"),s(" Node")],-1),d=n("h2",{id:"nodejs版本切换",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nodejs版本切换","aria-hidden":"true"},"#"),s(" NodeJs版本切换")],-1),m=n("br",null,null,-1),u=n("br",null,null,-1),v={href:"https://github.com/coreybutler/nvm-windows/releases",target:"_blank",rel:"noopener noreferrer"},b=n("br",null,null,-1),k=n("code",null,"nvm-setup.exe",-1),h=p(`<div class="custom-container warning"><p class="custom-container-title">注意</p><p>在安装nvm之前，可以把电脑中之前下载的nodejs卸载，不知道是否有影响<br> 在安装过程中首先第一个选择的是nvm的安装位置，第二个选择的是nodejs的安装位置。</p></div><p>安装完成之后，<code>win+r</code>调用cmd命令行，输入 <code>nvm ls</code> 命令查看当前有哪些nodejs版本，可以看到目前还没有任何版本<br> 比如我们使用nvm安装一个 <code>16.20.1</code> 的版本， 就可以输入 <code>npm install 16.20.1</code> 等待下载安装即可<br> 安装其他版本类似，只需换掉后面的版本号即可<br> 此时，再次输入 <code>nvm ls</code> 命令，可以看到，目前安装了两个版本</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C:<span class="token punctuation">\\</span>Users<span class="token punctuation">\\</span><span class="token number">1803</span><span class="token operator"><span class="token file-descriptor important">2</span>&gt;</span>nvm <span class="token function">ls</span>
